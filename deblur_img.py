...
def save_img(tensor_img, path="./example_images/deblurred/img1.png"):
...
def main():
    ...
    img = Image.open("./example_images/blurred/000008_blr.png").convert("RGB") # ./GOPRO_Large/test/GOPR0384_11_00/blur/000008.png
